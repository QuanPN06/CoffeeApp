...
public class HuyDon_Adapter extends  RecyclerView.Adapter<HuyDon_Adapter.ViewHolder>{
    private ArrayList<invoice> list;
    private Context context;


    private invoce_DAO invoce_dao;
    public HuyDon_Adapter(ArrayList<invoice> list, Context context){
        this.list = list;
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        View view = inflater.inflate(R.layout.item_huydon, parent, false);
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        ...
        holder.status.setText("Đơn Đã Bị Hủy");
    }
