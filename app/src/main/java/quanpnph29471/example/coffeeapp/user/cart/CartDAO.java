...
public class CartDAO {
    ...
    public ArrayList<Cart> getData(String sql, String... SelectAvg) {
        ...
        while (cursor.moveToNext()) {
            ...
            cart.setIdFood(cursor.getInt(cursor.getColumnIndex("coffee_id")));
    ...
    public long insert(Cart cart){
        ...
        values.put("coffee_id", cart.getIdFood());
    ...
    public boolean isFoodExists(int coffeeId, String username) {
        String query = "SELECT * FROM tbl_cart WHERE coffee_id = ? AND user_name = ?";
