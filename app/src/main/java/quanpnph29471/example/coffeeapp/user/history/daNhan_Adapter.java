...
public class daNhan_Adapter extends RecyclerView.Adapter<daNhan_Adapter.ViewHolder>{
    ...
    public daNhan_Adapter(ArrayList<invoice> list, Context context){
        this.list = list;
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        ...
        holder.status.setText("Đơn hàng đã thanh toán");
    }
